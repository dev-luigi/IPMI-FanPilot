...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "credentials_unreadable": {
        ...
        "de": "Gespeicherte Zugangsdaten konnten nicht gelesen werden",
        "fr": "Impossible de lire les identifiants enregistrés",
        "es": "No se pudieron leer las credenciales almacenadas",
        "it": "Impossibile leggere le credenziali salvate",
        "pt": "Não foi possível ler as credenciais armazenadas",
        "nl": "Opgeslagen inloggegevens konden niet worden gelezen",
        "ru": "Не удалось прочитать сохранённые учётные данные",
        "pl": "Nie można odczytać zapisanych poświadczeń",
        "zh-Hans": "无法读取已保存的凭据",
        "ja": "保存された認証情報を読み取れませんでした",
        "ko": "저장된 자격 증명을 읽을 수 없습니다",
    },
    "invalid_host": {
