...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "unsupported_port": {
        "en": "Only IPMI port 623 is supported",
        "de": "Nur der IPMI-Port 623 wird unterstützt",
        "fr": "Seul le port IPMI 623 est pris en charge",
        "es": "Solo se admite el puerto IPMI 623",
        "it": "È supportata solo la porta IPMI 623",
        "pt": "Apenas a porta IPMI 623 é suportada",
        "nl": "Alleen IPMI-poort 623 wordt ondersteund",
        "ru": "Поддерживается только порт IPMI 623",
        "pl": "Obsługiwany jest tylko port IPMI 623",
        "zh-Hans": "仅支持 IPMI 端口 623",
        "ja": "IPMI ポート 623 のみがサポートされています",
        "ko": "IPMI 포트 623만 지원됩니다",
    },
    "credentials_required_for_host_change": {
        "en": "Re-enter the BMC username and password to change the host address",
        "de": "Geben Sie den BMC-Benutzernamen und das Passwort erneut ein, um die Hostadresse zu ändern",
        "fr": "Saisissez à nouveau le nom d'utilisateur et le mot de passe BMC pour changer l'adresse de l'hôte",
        "es": "Vuelva a introducir el usuario y la contraseña del BMC para cambiar la dirección del host",
        "it": "Reinserisci nome utente e password del BMC per cambiare l'indirizzo host",
        "pt": "Introduza novamente o utilizador e a palavra-passe do BMC para alterar o endereço do host",
        "nl": "Voer de BMC-gebruikersnaam en het wachtwoord opnieuw in om het hostadres te wijzigen",
        "ru": "Введите имя пользователя и пароль BMC заново, чтобы изменить адрес узла",
        "pl": "Wprowadź ponownie nazwę użytkownika i hasło BMC, aby zmienić adres hosta",
        "zh-Hans": "请重新输入 BMC 用户名和密码以更改主机地址",
        "ja": "ホストアドレスを変更するには、BMC のユーザー名とパスワードを再入力してください",
        "ko": "호스트 주소를 변경하려면 BMC 사용자 이름과 비밀번호를 다시 입력하세요",
    },
